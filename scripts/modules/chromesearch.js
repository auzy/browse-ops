define(["./analysis", "./htmlconnector"], function(analysis, htmlconnector) {
  return {
    retrieveHistory: function(divName, process) {
      ...
      var processVisits = {
        tracking: function(url, visitItems) {

          if (analysis.sorttrackingurls(url)) {
          
            var shortUrl = url.substring(analysis.httpslicer(url), url.indexOf("/", 9));
